    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="widget"><h3 class="widget__title">Tải ứng dụng BTH</h3>
                    <div class="widget__text mr--md--24">
                        <div class="row mb--36">
                            <div class="col-md-4">
                                <div class="col-md-5 " style="margin: 10px" ><img alt="Luxstay" width="100"
                                                   height="100" src="{{asset('source/images/qr-code.png')}}"
                                    >
                                </div>
                            </div>
                            <div class="col-md-5 is-flex align-center">
                                <div class="row">
                                    <div class="col-xs-12" style="padding:5px 5px;margin: 5px"><a target="_blank" class="d-inline-block mb--18"><img
                                                width="160" height="40"
                                                src="https://www.luxstay.com/icons/apple-store.svg"></a>
                                    </div>
                                    <div class="col-xs-12" style="padding:5px 5px;margin: 5px"><a target="_blank"
