        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="img-years">
                        <img src="source/images/img_1.jpg" alt="Image" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-5 ml-auto pl-lg-5 text-center">
                    <h3 class="text-center mb-4">Brokerage Company Started.</h3>
                    ...
                    <p class="mt-5"><a href="{{route('contact')}}" class="btn btn-primary text-white">Contact Us</a></p>
                </div>
            </div>
        </div>
    </div>
